...
export class SignupComponent {
  ...
  submitRegister() {
    ...
    console.log(this.signUpForm.get('gender').value); // 'gender' alanındaki değeri yazdırır
    if(this.signUpForm.get('gender').value == "true")
      this.signUpForm.patchValue({
        gender: true // gender alanını "Kadın" olarak değiştirir
      });
      else
      this.signUpForm.patchValue({
        gender: false // gender alanını "Kadın" olarak değiştirir
      });
